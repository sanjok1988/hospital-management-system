            ...
            <div class="navbar-header" style="background-color: #454952;"> <a class="navbar-toggle hidden-sm hidden-md hidden-lg " href="javascript:void(0)" data-toggle="collapse" data-target=".navbar-collapse"><i class="fa fa-bars"></i></a>
               ...
               <!-- <ul class="nav navbar-top-links navbar-left m-l-20 hidden-xs">
                ...
                <ul class="nav navbar-top-links navbar-right pull-right">
                    <li>
                        <a class="profile-pic" href="{{route('logout')}}"> <img src="plugins/images/users/manish.jpg" alt="user-img" width="48" height="48" class="img-circle" style="margin-top: 15px;">
        ...
        <div class="navbar-default sidebar" role="navigation" style="background-color: #454952;">
            <div class="sidebar-nav navbar-collapse slimscrollsidebar ">
                <ul class="nav" id="side-menu ">
                    ...
                    <li>
                        <a href="{{url('doctor')}}" class="waves-effect"><i class="fa fa-user fa-fw" aria-hidden="true"></i><span class="hide-menu">Doctor</span></a>
                    </li>
                    <li>
                        <a href="{{url('patient')}}" class="waves-effect"><i class="fa fa-users fa-fw" aria-hidden="true"></i><span class="hide-menu">Patients</span></a>
                    </li>
                   
                    <li>
                        <a href="{{url('viewappointment')}}" class="waves-effect"><i class=" 
                            fa fa-clock-o fa-fw" aria-hidden="true"></i><span class="hide-menu">Appointment</span></a>
                    </li>
@role('admin')
                    <li>
                        <a href="{{url('users')}}" class="waves-effect"><i class="fa fa-users fa-fw" aria-hidden="true"></i><span class="hide-menu">Users</span></a>
                    </li>
                  @endrole  
