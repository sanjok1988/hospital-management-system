...
<body style="margin-top: 20px; margin-bottom: 20px;  width: 100%">
	
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form validate-form" action="{{('doctor/profile')}}" method ="POST">
					...
					<div class="wrap-input100 rs2-wrap-input100 " data-validate="Type password">
						<input class="input100 {{ $errors->has('password') ? ' is-invalid' : '' }}" type="password" name="pass" placeholder="Password" required>
					...
					<label style="margin-top: 10px;"><b>Select your type: </b></label>
					<div class="wrap-input100 rs2-wrap-input100 ">
						<select class="wrap-input100 rs2-wrap-input100 ">
		...
		<div class="login100-more" style="background-image: url('login/images/hospital.jpg');"></div>
			</div>
		</div>
	</div>
