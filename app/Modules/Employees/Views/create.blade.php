   ...
   <form role="form" method="POST" action="{{ route($page.'.store')}}">
      ...
      <div class="box-body">
         ...
         <div class="col-md-6">
            ...
            <input type="text" class="form-control" name="first_name" placeholder="First Name" value="{{ ($flag)?$data->first_name:'' }}" >
            </div>
            <div class="form-group">
         ...
         <div class="col-md-6">
            ...
            <div class="form-group">
               ...
               <input type="text" class="form-control" name="work_email" placeholder="Work Email" value="{{ ($flag)?$data->work_email:'' }}">
            </div>
